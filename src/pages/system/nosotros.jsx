        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 pb-6 text-center">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              El equipo está compuesto por expertos en tecnología, atención al
              cliente, y logística, quienes trabajan mano a mano para que los
              profesionales de la salud encuentren el espacio ideal para sus
              consultas, cirugías o reuniones. Cada miembro de nuestro equipo
              está dedicado a brindar un servicio excepcional, asegurando una
              experiencia fluida y sin complicaciones para nuestros usuarios.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 relative">
                ...
                return (
                  <div className="tiny-slide" key={index}>
                    ...
                    >
                      <img
                        src={item}
                        className="sm:size-40 object-cover"
                        alt=""
                      />
                    </Link>
                  </div>
          ...
          {isOpen && (
            <Lightbox
              ...
              prevSrc={
                placeImage[
                  (currentImageIndex + placeImage.length - 1) %
                    placeImage.length
                ]
              }
