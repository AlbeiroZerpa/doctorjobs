                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 gap-3">
                      <div className="lg:col-span-6">
                        ...
                        <input
                          ...
                          id="name"
                          type="text"
                          className="mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-400 dark:border-gray-800 focus:ring-0"
                          placeholder="Nombre:"
                          required
                        />
                      </div>
                      ...
                      <div className="lg:col-span-12">
                        ...
                        <textarea
                          name="comments"
                          id="comments"
                          className="mt-2 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-400 dark:border-gray-800 focus:ring-0"
                          placeholder="Mensaje:"
                        ></textarea>
                      </div>
                    </div>
            ...
            <div className="text-center px-6">
              ...
              <div className="content mt-7">
                ...
                <p className="text-slate-400 mt-3">
                  La secuencia de frases del es ahora para que muchos hagan
                  campaña y se beneficien.
                </p>
