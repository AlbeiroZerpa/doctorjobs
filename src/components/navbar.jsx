  ...
  return (
    <nav id="topnav" className={`${navclass} ${scrolling ? "nav-sticky" : ""}`}>
      <div className="container relative">
        ...
        {user && (
          <ul className="buy-button list-none">
        ...
        <div id="navigation" style={{ display: isToggle ? "block" : "none" }}>
          <ul className={`navigation-menu ${manuclass}`}>
            ...
            >
              <Link to="/nosotros" className="sub-menu-item">
                Nosotros
              </Link>
            </li>
            ...
            <li
              className={`has-submenu parent-menu-item ${
                ["/consultorio", "/quirófano", "/saladereuniones"].includes(
                  manu
                )
                  ? "active"
                  : ""
            ...
            >
              ...
              >
                <li className={`${manu === "/consultorio" ? "active" : ""}`}>
                  <Link to="/consultorio" className="sub-menu-item">
                    Consultorio
                  </Link>
                </li>
                <li className={`${manu === "/quirófano" ? "active" : ""}`}>
                  <Link to="/quirófano" className="sub-menu-item">
                    Quirófano
                  </Link>
                </li>
                <li
                  className={`${manu === "/saladereuniones" ? "active" : ""}`}
                >
                  <Link to="/saladereuniones" className="sub-menu-item">
                    Sala de reuniones
                  </Link>
                </li>
              </ul>
            ...
            >
              <Link to="/planes" className="sub-menu-item">
                Planes
              </Link>
            </li>
            <li
              className={`${
                location.pathname === "/contactanos" ? "active" : ""
              }`}
            >
              <Link to="/contactanos" className="sub-menu-item">
                Contáctanos
              </Link>
            </li>
            {!user && (
