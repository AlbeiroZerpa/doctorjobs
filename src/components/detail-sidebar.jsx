...
import { FiLink, FiMail, FiMapPin, FiPhone, FiUser, FiUsers } from "../assets/icons/vander"
            ...
            <div className="lg:col-span-4 md:col-span-5">
                <div className="p-4 rounded-md shadow dark:shadow-gray-700 sticky top-20">
                    ...
                    <div className="mt-4">
                        ...
                        >
                            {isLoading ? <Spinner className="mx-auto block" /> : 'Alquiler'}
                        </button>
                    </div>
            ...
            {isOpen && <>
                ...
                >
                    ...
                    <div className="p-8 rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-black w-full max-w-md mx-4 relative">
                        <h3 className='text-center'>No posees los puntos suficiente por favor compre mas puntos</h3>
                        <div className="flex justify-center">
                            ...
                            <button onClick={() => navigate("/planes")} className='mx-2 mt-4 block py-2 px-5 tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md'>
                                Comprar
                            </button>
                        </div>
                    </div>
            ...
            {isOpenPassed && <>
                ...
                >
                    ...
                    <div className="p-8 rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-black w-full max-w-[80%] max-h-[75%] overflow-y-scroll mx-4 relative">
                        ...
                        <div className="flex justify-center">
                            <button onClick={() => setIsOpenPassed(!isOpenPassed)} className='mx-2 mt-4 block py-2 px-5 tracking-wide align-middle duration-500 text-base text-center border border-red-500 text-red-500 dark:text-white rounded-md'>
                                Cerrar
                            </button>
